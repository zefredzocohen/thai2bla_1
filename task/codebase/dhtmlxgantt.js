...
window.dhtmlx || (dhtmlx = function(t) {
    ...
    if (i)
        ...
        return"<task id='" + t.id + "' parent='" + (t.parent || "") + "' start_date='" + e + "' duration='" + t.duration + "' open='" + !!t.open + "' progress='" + t.progress + "' emp_id='" + t.emp_id + "' end_date='" + n + "'><![CDATA[" + t.text + "]]></task>"
    }, serialize: function() {
        var t = [], e = [];
        gantt.eachTask(function(e) {
            t.push(this._copyObject(e))
...
}, gantt.skins = {}, gantt._lightbox_methods = {}, gantt._lightbox_template = "<div class='dhx_cal_ltitle'><span class='dhx_mark'>&nbsp;</span><span class='dhx_time'></span><span style='display:none' class='dhx_title'></span></div><div class='dhx_cal_larea'></div>", gantt.showLightbox = function(t) {
...
}), gantt.locale = {date: {month_full: ["Tháng 1 Năm ", "Tháng 2 Năm ", "Tháng 3 Năm ", "Tháng 4 Năm ", "Tháng 5 Năm ", "Tháng 6 Năm ", "Tháng 7 Năm ", "Tháng 8 Năm ", "Tháng 9 Năm ", "Tháng 10 Năm ", "Tháng 11 Năm ", "Tháng 12 Năm "], month_short: ["Tháng 1", "Tháng 2", "Tháng 3", "Tháng 4", "Tháng 5", "Tháng 6", "Tháng 7", "Tháng 8", "Tháng 9", "Tháng 10", "Tháng 11", "Tháng 12"], day_full: ["Chủ nhật", "Thứ 2", "Thứ 3", "Thứ 4", "Thứ 5", "Thứ 6", "Thứ 7"], day_short: ["Thứ 2", "Thứ 3", "Thứ 4", "Thứ 5", "Thứ 6", "Thứ 7", "Chủ nhật"]}, labels: {new_task: "New task", icon_save: "Save", icon_cancel: "Cancel", icon_details: "Details", icon_edit: "Edit", icon_delete: "Delete", confirm_closing: "", confirm_deleting: "Dự án - Công việc này sẽ bị xóa vĩnh viễn, bạn chắc chắn muốn xóa", section_description: "Tên dự án - công việc",section_report: "Báo cáo chi tiết", section_time: "Thời hạn (ngày)", section_type: "Type", column_text: "Tên công việc", column_start_date: "Thời gian bắt đầu", column_duration: "Thời hạn (ngày)", column_add: "", link: "Liên kết giữa", confirm_link_deleting: "sẽ bị xóa", link_start: " (Bắt đầu)", link_end: " (Kết thúc)", type_task: "Công việc", type_project: "Dự án", type_milestone: "Sự kiện quan trọng", minutes: "Minutes", hours: "Hours", days: "Days", weeks: "Tuần", months: "Months", years: "Years"}}, gantt.skins.skyblue = {config: {grid_width: 350, row_height: 27, scale_height: 27, task_height: 24, link_line_width: 1, link_arrow_size: 8, lightbox_additional_height: 75}, _second_column_width: 95, _third_column_width: 80}, gantt.skins.meadow = {config: {grid_width: 350, row_height: 27, scale_height: 30, task_height: 24, link_line_width: 2, link_arrow_size: 6, lightbox_additional_height: 72}, _second_column_width: 95, _third_column_width: 80}, gantt.skins.terrace = {config: {grid_width: 360, row_height: 35, scale_height: 35, task_height: 24, link_line_width: 2, link_arrow_size: 6, lightbox_additional_height: 75}, _second_column_width: 90, _third_column_width: 70}, gantt.skins.broadway = {config: {grid_width: 360, row_height: 35, scale_height: 35, task_height: 24, link_line_width: 1, link_arrow_size: 7, lightbox_additional_height: 86}, _second_column_width: 90, _third_column_width: 80, _lightbox_template: "<div class='dhx_cal_ltitle'><span class='dhx_mark'>&nbsp;</span><span class='dhx_time'></span><span style='display:none' class='dhx_title'></span><div class='dhx_cancel_btn'></div></div><div class='dhx_cal_larea'></div>", _config_buttons_left: {}, _config_buttons_right: {dhx_delete_btn: "icon_delete", dhx_save_btn: "icon_save"}}, gantt.config.touch_drag = 50, gantt.config.touch = !0, gantt._init_touch_events = function() {
