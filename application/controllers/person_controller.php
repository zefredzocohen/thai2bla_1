...
//		if($this->Customer->get_info2($person_id)->num_rows() > 0){
//			$data_row=get_person_data_row($this->Person->get_info($person_id),$this);
//		}else{
//			$data_row=get_emp_data_row($this->Person->get_info($person_id),$this);
//		}
//		echo $data_row;
//	}
...
//		echo $data_row;
             $person_id = $this->input->post('row_id');           
            if($this->Customer->get_info2($person_id)->num_rows() > 0){                  
            $data_row=get_person_data_row($this->Person->get_info_customer($person_id),$this);
