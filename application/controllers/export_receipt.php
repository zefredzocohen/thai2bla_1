...
$this->excel->getActiveSheet()->setCellValue('D2',"HOÁ ĐƠN BÁN HÀNG ");
...
//$this->excel->getActiveSheet()->setCellValue('C16',"Họ tên Người mua hàng");
//$this->excel->getActiveSheet()->setCellValue('D16',"(Customer Name): ");
...
foreach(array_reverse($data['cart'], true) as $line=>$item){
	...
	$this->excel->getActiveSheet()->setCellValue('H'.$k,$item['price']);
        $this->excel->getActiveSheet()->getStyle('H'.$k)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
	$this->excel->getActiveSheet()->setCellValue('I'.$k,to_currency_unVND($item['price']*$item['quantity']-$item['price']*$item['quantity']*$item['discount']/100));
	...
	$this->excel->getActiveSheet()->getStyle('B'.$k.':I'.$k)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
        $this->excel->getActiveSheet()->getStyle('B24:I' . ($k))->applyFromArray($styleDOTBlackBorderOutline);
...
$i = $this->excel->getActiveSheet()->getHighestRow() +2;
...
$this->excel->getActiveSheet()->setCellValue('I'.$i,to_currency_unVND($tongtienhang));
...
$this->excel->getActiveSheet()->getStyle('D'.($i+1))->getFont()->setSize(10);
...
$this->excel->getActiveSheet()->setCellValue('I'.($i+2),to_currency_unVND($tongtienhang));
...
$this->excel->setActiveSheetIndex(0)->mergeCells('B'.($i+3).':C'.($i+3));
$this->excel->setActiveSheetIndex(0)->mergeCells('D'.($i+3).':I'.($i+3));
...
$this->excel->getActiveSheet()->getCell('B'.($i+3))->setValue($objRichText7);
$this->excel->getActiveSheet()->getStyle('B'.($i+3))->getAlignment()->setIndent(1);
$this->excel->getActiveSheet()->getStyle('B'.($i+3).':I'.($i+3))->getBorders()->getTOP()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('B'.($i+3))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
...
$this->excel->getActiveSheet()->getCell('B'.($i+4))->setValue($objRichText3);
...
//
//$this->excel->setActiveSheetIndex(0)->mergeCells('C'.($i+4).':E'.($i+4));
//$this->excel->getActiveSheet()->getStyle('C'.($i+4))->getFont()->setBold(true);
//$this->excel->getActiveSheet()->getStyle('C'.($i+4))->getFont()->setsIZE(10);
//$this->excel->getActiveSheet()->setCellValue('C'.($i+4),"Người giao hàng ");
//$this->excel->getActiveSheet()->getStyle('C'.($i+4))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);

$this->excel->setActiveSheetIndex(0)->mergeCells('D'.($i+4).':F'.($i+4));
...
$this->excel->getActiveSheet()->getCell('D'.($i+4))->setValue($objRichText90);
$this->excel->getActiveSheet()->getStyle('D'.($i+4))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$this->excel->setActiveSheetIndex(0)->mergeCells('G'.($i+4).':I'.($i+4));
...
$this->excel->getActiveSheet()->getCell('G'.($i+4))->setValue($objRichText4);
$this->excel->getActiveSheet()->getStyle('G'.($i+4))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

//$this->excel->setActiveSheetIndex(0)->mergeCells('B'.($i+5).':C'.($i+5));
//$this->excel->getActiveSheet()->setCellValue('B'.($i+5),'(Ký, ghi rõ họ tên - Sign, Fullname)');
//$this->excel->getActiveSheet()->getStyle('B'.($i+5))->getFont()->setItalic(true);
//$this->excel->getActiveSheet()->getStyle('B'.($i+5))->getFont()->setSize(8);
...
//$this->excel->getActiveSheet()->setCellValue('D'.($i+5),'(Ký, ghi rõ họ tên - Sign, Fullname)');
//$this->excel->getActiveSheet()->getStyle('D'.($i+5))->getFont()->setItalic(true);
//$this->excel->getActiveSheet()->getStyle('D'.($i+5))->getFont()->setSize(8);
//$this->excel->getActiveSheet()->getStyle('D'.($i+5))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
//
//$this->excel->setActiveSheetIndex(0)->mergeCells('G'.($i+5).':I'.($i+5));
//$this->excel->getActiveSheet()->setCellValue('G'.($i+5),'(Đóng dấu ghi rõ họ tên - Sign, Stamp, Fullname)');
//$this->excel->getActiveSheet()->getStyle('G'.($i+5))->getFont()->setItalic(true);
//$this->excel->getActiveSheet()->getStyle('G'.($i+5))->getFont()->setSize(8);
...
$this->excel->getActiveSheet()->setCellValue('B'.($i+5),'  (Ký, ghi rõ họ tên - Sign,Fullname)                             (Ký, ghi rõ họ tên - Sign,Fullname)     (Đóng dấu ghi rõ họ tên - Sign, Stamp,Fullname)');
$this->excel->getActiveSheet()->getStyle('B'.($i+5))->getFont()->setItalic(true);
$this->excel->getActiveSheet()->getStyle('B'.($i+5))->getFont()->setSize(8);
$this->excel->setActiveSheetIndex(0)->mergeCells('B45'.':I45');

//$this->excel->getActiveSheet()->getHeaderFooter()->setOddFooter('&L&B' .);
$this->excel->getActiveSheet()->setCellValue('B45',"Ghi chú: Quý khách hàng xin vui lòng kiểm tra kỹ đơn hàng và ký nhận đầy đủ");
$this->excel->getActiveSheet()->getStyle('B45')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
$this->excel->getActiveSheet()->getStyle('J'.($i-2).':J45')->getBorders()->getRIGHT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('A'.($i-2).':A45')->getBorders()->getRIGHT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
//$this->excel->getActiveSheet()->getStyle('B'.($i).':J'.($i+12))->getBorders()->getBOTTOM()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('B45'.':J45')->getBorders()->getBOTTOM()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
$this->excel->getActiveSheet()->getColumnDimension('E')->setWidth(6.55);
$this->excel->getActiveSheet()->getColumnDimension('F')->setWidth(6.33);
$this->excel->getActiveSheet()->getColumnDimension('G')->setWidth(7.2);
$this->excel->getActiveSheet()->getColumnDimension('H')->setWidth(10.33);
