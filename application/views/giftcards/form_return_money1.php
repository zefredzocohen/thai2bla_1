...
<div id="print_form" style="width:500px">
 <fieldset class="form_fieldset" id="fieldset_giaoca">
	 ...
	 <div class="field_row clearfix">
		  <?php echo form_label('Số tài khoản'); ?>
		  <div class='form_field'>
			<?php   echo form_input(array('id'=>'money_input','value'=>$this->Giftcard->get_id_cart($giftcards->giftcard_number),'class'=>'tongtien','size'=>25)); ?>
		  </div>
	  </div>
	 <div class="field_row clearfix">
