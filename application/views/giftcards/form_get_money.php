...
<div id="content_area" style="color: #000">
	...
	<tr>
		...
		<td id="title">
                    <span style="color: #fff">Nạp tiền cho thẻ thanh toán</span>
		</td>
...
<div id="print_form" style="">
 <fieldset class="form_fieldset" id="fieldset_giaoca">
	...
	<div class="field_row clearfix">
		  <?php  echo form_label('Số tiền nạp '); ?>
		  <div class='form_field'>
			<input type="text" name="money_add" id="money_add">
		  </div>
	</div>
	<div class="field_row clearfix">
		  <?php  echo form_label('Tổng tiền'); ?>
		  <div class='form_field'>
...
<div id="add_money">
	...
	<?php echo form_fieldset('Tiến hành nạp tiền',array('id'=>'fieldset','class'=>'form_fieldset')); ?>
	  <div class="field_row clearfix">
		  <?php echo form_label('Mã số thẻ thanh to:'); ?>
		  <div class='form_field'>
	  ...
	  <input type="hidden" name="sotien" value="<?php echo $giftcards->value; ?>">
	  <div class="field_row clearfix">
		  <?php echo form_label('Tên khách hàng'); ?>
		  <div class='form_field'>
...
<script src="<?php echo base_url(); ?>js/jquery_1.js" type="text/javascript"></script>
...
$(document).ready(function () {
	...
	$('.submit_button_float_right').click(function(){
		...
		var tien_nap=$("#price_cost1").val();
		jQuery.ajax({
			type:'Post',
			url:'<?php echo site_url("giftcards/update_get_money") ?>',
			data:"sum_money="+summoney+"&id_giftcards="+idgiftcard+"&tien_nap="+tien_nap,
    ...
    $('#price_cost1343').ForceNumericOnly();
});
</script>