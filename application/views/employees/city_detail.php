...
{ 
    ...
    enable_sorting("<?php echo site_url($controller_name."/sorting_city_detail"); ?>",table_columns, <?php echo $per_page; ?>);            
	enable_search('<?php echo site_url($controller_name."/suggest_city_detail");?>',<?php echo json_encode(lang("common_confirm_search"));?>);            
...
<table id="title_bar_new">
    <tr>
		...
		<?php echo "Nhân viên trong thành phố ".$info_city->jobs_city_name ?>  
		</td>  
        
        
        <?php $type_customers = $this->Customer->get_Customer_type(); ?>
        <td id="title_search_new" >
            <?php echo form_open("$controller_name/search_city_detail",array('id'=>'search_form')); ?>
