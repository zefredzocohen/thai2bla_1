<div style="float:left; width: 100%">
    <fieldset id="employee_permission_info" style="color: #000; width: 100%;padding: 0; margin: 0">
        ...
        <label><p style="height:40px;line-height: 20px;display: block;margin: -4px 0 0 6px">
			 <input type="checkbox" id="select_one" style='float: left;margin-right: 7px' disabled="disabled" /><span style='margin-top: -2px;float:left;display: inline-block'> Chọn phân quyền toàn bộ cho nhân viên này. </span>
		</p></label>
		  <script>
		...
		<ul id="permission_list" style="float: left;">
            ...
            foreach($all_modules->result() as $module)
            {
                ...
                ?>
                <li style="float: left;width: 200px;height: 140px;font-family: Arial, Geneva,sans-serif;border: 1px solid #F5F5F5;">
