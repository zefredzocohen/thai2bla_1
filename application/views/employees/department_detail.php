...
{ 
    ...
    enable_sorting("<?php echo site_url($controller_name."/sorting_department_detail"); ?>",table_columns, <?php echo $per_page; ?>);            
	enable_search('<?php echo site_url($controller_name."/suggest_department_detail");?>',<?php echo json_encode(lang("common_confirm_search"));?>);            
...
<table id="title_bar_new">
    <tr>
		...
		<?php echo "Nhân viên trong thành phố ".$info_department->department_name ?>            
		</td>  
        
        
        <?php $type_customers = $this->Customer->get_Customer_type(); ?>
        <td id="title_search_new" >
            <?php echo form_open("$controller_name/search_department_detail",array('id'=>'search_form')); ?>
