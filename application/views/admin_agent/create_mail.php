        ...
        <table id="contents">
            <tr>
                <td id="commands">
                    <div id="new_button">
                           <?php 
                                echo anchor("customers/manage_mail",
                                    'Danh sách mail',
                    ...
                    <div id="item_table">
                        <div id="table_holder">
                            ...
                            <div class="field_row clearfix">
                                <label style="display: inline-block;height:30px;line-height:24px;text-indent: -1px;margin-bottom: 10px;width:130px">Tiêu đề gửi mail :</label>
                            ...
                            <div class="field_row clearfix">
                            <label style="display: block;height:30px;line-height:30px;text-indent: -1px;margin-bottom: 10px">Nội dung gửi mail :</label>
                            <div class="clearfix"></div>
                                    <div class='form_field'>
                ...
                submitHandler:function(form){
                    ...
                    $(form).ajaxSubmit({
                        success:function(response){	
                            ...
                            submitting = false;
                            tb_remove();
                            window.location.href = "index.php/customers/manage_mail";                            
