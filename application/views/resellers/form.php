            ...
            <tr>
                ...
                <td>
                    ...
                    <div id="item_table">
                        <div id="table_holder">
                            <?php
                            echo form_open('resellers/save/'.$support_info->id,array('id'=>'customer_mail_form'));
                            ?>
                ...
                <div class="field_row clearfix">
                    <?php if ($support_info->images == null) { ?>
                        <div class="" style="border: none">
                            <div class='form_field'>
                                <img src="<?php echo base_url() . 'resellers_images/noImage.gif' ?>" style="width:150px; height:150px" />
                            </div>
                        </div>
                    <?php } else { ?>
                        <div class="field_row clearfix" style="border-bottom:none">
                            <div class='form_field'>
                                <img src="<?php echo base_url() . 'resellers_images/' . $support_info->images ?>" style="width:150px; height:150px" />
                            </div>
                        </div>
                    <?php } ?>
                </div>
