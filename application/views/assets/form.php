<?= form_open('assets/save/'.$var_info->id,array('id'=>'assets_form'));?>
<div id="required_fields_message"><?= lang('common_fields_required_message'); ?></div>
<ul id="error_message_box"></ul>
<fieldset id="supplier_basic_info">
<legend><?= lang("var_information"); ?></legend>
<div class="field_row clearfix">	
<?= form_label(lang('assets_number').':', ' assets_number', array('class'=>'required')); ?>
    <div class='form_field'>
    <?= form_input(array(
        'name'=>'assets_number',
        'id'=>'assets_number',
        'value'=>$var_info->asset_number
    ));?>
    </div>
</div>
<div class="field_row clearfix">	
...
<div class="field_row clearfix">	
<?= form_label(lang('assets_value').':', ' value', array('class'=>'')); ?>
    <div class='form_field'>
    <?= form_input(array(
        'name'=>'value',
        'id'=>'value',
...
<div class="field_row clearfix">	
<?= form_label(lang('assets_value_remain').':', ' value_remain', array('class'=>'')); ?>
    <div class='form_field'>
    <?= form_input(array(
        'name'=>'value_remain',
        'id'=>'value_remain',
...
<!--<div class="field_row clearfix">	
<?= form_label('Số lượng:', ' quantity', array('class'=>'')); ?>
    <div class='form_field'>
    <?= form_input(array(
        'name'=>'quantity',
        'id'=>'quantity',
        'value'=>$var_info->quantity
    ));?>
    </div>
</div>-->
<!-- 12/02/2014-->
...
?>
<div class="field_row clearfix">
    <?= form_label(lang('assets_group').':', 'group',array('class'=>'')) ?>
 	<div class='form_field'>
...
<?= form_label(lang('assets_date_tang').':', 'date_tang'); ?>
    ...
    <?= form_input(array(
        'name'=>'date_tang',
        'id'=>'date_tang',
        'value'=> $var_info->date_tang != '01-01-1950'
                ? date(
                    get_date_format(),
                    strtotime( 
                        $var_info->date_tang != ''
...
<!-- end bo phan su dung -->
<!--<div class="field_row clearfix">
    <?= form_label('Tài khoản nguyên giá:', 'tktk'); ?>
    <div class='form_field'>
        <?= form_input(array(
            'name'=>'tktk',
            'id'=>'tktk',
