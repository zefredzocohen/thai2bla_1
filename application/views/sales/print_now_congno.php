...
<div id="content_area_wrapper">
    ...
    <?php echo $item['quantity']; ?>
                            ...
                            <td style="width: 15%; text-align: right; border: 1px solid #000000; padding: 3px;">
    <?php
    if ($item['unit'] == "unit") {
    ...
    ?>
                    ...
                    ?>
                    <tr>
                        <td colspan="5" style="text-align: right;">Tiền còn nợ:</td>
                        <td colspan="3" style="text-align: right;">
                            <?php echo to_currency_unVND_nomar($total_order - $total_discount_money - $total_payment + $total_taxes_percent) ?>
                        </td>
                    </tr>
                     <?php
                     ...
                     ?>
                    <tr>
                        <td colspan="5" style="text-align: right;">Tổng nợ cũ:</td>
                        <td colspan="3" style="text-align: right;">
                          <?php
                   ...
                   ?>
                    ...
                    <tr>
                        <td colspan="8" style="text-align: center">
                            <div style="width: 280px; margin-top: 10px; border-top: 1px dotted #000000;"></div>
