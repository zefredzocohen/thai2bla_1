...
<?php
echo form_open('language/save/'.$item_info->id_language,array('id'=>'language_form'));
?>
<fieldset id="item_basic_info">
<legend><?php echo lang("items_basic_language"); ?></legend>

<div class="field_row clearfix">
<?php echo form_label(lang('name_language').':', 'name_language',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'name_language',
		'id'=>'name_language',
		'value'=>$item_info->name_language)
	);?>
	</div>
</div>
...
{
    setTimeout(function(){$(":input:visible:first","#language_form").focus();},100);
	...
	$('#language_form').validate({ /*sau khi them submit no se goi lai manage*/
