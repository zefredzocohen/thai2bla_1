<?php
echo form_open_multipart('suppliers/do_excel_import/',array('id'=>'item_form'));
?>
<div id="required_fields_message" style="font-size: 11px"><?php echo lang('items_mass_import_from_excel'); ?></div>
<ul id="error_message_box"></ul>
<div id="import_excel"><h2 id="h2_one"><a href="<?php echo site_url('suppliers/excel'); ?>"><?php echo lang('items_download_import_template'); ?></a></h2></div>
<fieldset id="item_basic_info" style="margin: 0px auto; width: 99%">
<legend style="font-size: 12px"><?php echo 'Chọn file excel tải lên'; ?></legend>
