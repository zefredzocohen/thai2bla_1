...
{ 	
    ...
    enable_delete(<?php echo json_encode(lang($controller_name."_confirm_delete"));?>,<?php echo json_encode(lang($controller_name."_none_selected"));?>);
		...
		<!-- phan lam mua hang -->
	$('#supplier_trading').click(function()
    {
		...
		// alert(selected);
    	 $(this).attr('href','<?php echo site_url("suppliers/trading");?>/'+selected);
    });
...
<table id="title_bar_new" style="width: 960px;">
	<tr>
		<td id="title_icon">
			<img src='<?php echo base_url()?>images/menubar/<?php echo $controller_name; ?>.png' alt='title icon' />
		</td>
                <td id="title" style="width: 260px;">
	...
	<tr>
		<td id="commands">
			<div id="new_button">
				...
				<!-- phan lam -->
				<?php
				if ($this->receiving_lib->get_supplier() == -1){
					echo anchor("$controller_name/trading",
					lang('supplier_trading'),
					array('class'=>'none','id'=>'supplier_trading'));
				}
				else {
					echo anchor("$controller_name",
					lang('supplier_trading_exits'),
					array('class'=>'none','id'=>'supplier_trading_exits'));
				}
				?>
                                 <?php
                                ...
                                ?>
				<style type="text/css">
				#supplier_trading, #supplier_trading_exits{background-position: -10px -130px;}
				</style>
