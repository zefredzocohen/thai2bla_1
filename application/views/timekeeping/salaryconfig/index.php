...
function select_inv(){
	 ...
	 if (confirm(<?php echo json_encode("Bạn có muốn chọn tất cả thuộc tính lương đã chọn không"); ?>))
    	{
...
<table id="title_bar_new">
  <tr>
	...
	<?php echo form_open("$controller_name/search",array('id'=>'search_form')); ?>
        <input  type="text" name ='search' id='search' placeholder="Tên thuộc tính cần tìm ..."/>
...
<table id="contents">
  <tr>
    <td id="commands"><div id="new_button">
        ...
        <?php echo 
					anchor("$controller_name/view/-1/width~400/height~400",
