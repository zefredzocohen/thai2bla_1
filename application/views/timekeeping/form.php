...
<div id="showAll">
    ...
    <a href="<?php echo site_url('timekeeping/loadEmployees/'.$timekeepings->timekeepings_id)?>" style="display: none" id="showEmployeesAll"></a>

    <script type="text/javascript">
        /*
         * Thực  hiện load toàn bộ thông tin khi ta thực hiên chọn select Khu vực
         * */
        ...
        /*
         * Thực hiện load thông tin khi chọn chi nhánh
         */
        ...
        /*
         * Thực hiện load thông tin khi chọn phòng ban
         */
        ...
        /*
         *  Function thực hiên lấy ten department trong khu vực
         * */
		...
		function clickSendEmployees(){
			var person_id = $('#jobs_person_name').val();
			$.post($("#showEmployeesAll").attr('href'),{person_id:person_id},function(data,success){
				if(success){
					$("#showAll").html(data);
				}
			});
