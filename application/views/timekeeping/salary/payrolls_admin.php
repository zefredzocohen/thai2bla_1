...
<div id="main_content">
    ...
    <div style="margin-bottom: 50px">
        <div class="min-company">LifetePos - 2014</div>
    ...
    <table id="paypolls" width="1000" cellpadding="0" cellspacing="0">
        ...
        if($person_id == 1){ ?>
            <div id="manager_salary_one">
                ...
                <?php }else{ ?>
                    <input type="submit" name="reset_manager" id="report_button" value="Duyệt lại" />
                <?php }?>
                </br>
        ...
        <?php }else{ ?>
            <div id="manager_salary_one">
                <?php if($manager_info->status == 0) {?>
                    <button type="submit" name="report_button" id="report_button" >Lập bảng lương</button>
                    </br>
                    <div id="salary_textarea" style="margin: 50px 0 0 110px;">
