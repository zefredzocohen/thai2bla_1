<?php
echo form_open_multipart('jobs_employee/save/'.$jobs_employees->jobs_employees_id,array('id'=>'jobs_employees_form'));
?>
<div id="required_fields_message"><?php echo lang('common_fields_required_message'); ?></div>
<div id="error"></div>
<fieldset id="jobs_basic_info" style="width: 100%;height: 650px">
    <legend><?php echo lang("jobs_employees_information_info"); ?></legend>
    <?php $this->load->view("jobs/employees/jobs_employees/form_info");
