...
<div id="container">
    <div id="title_bar_new">
        <div  id="title" style="color:#fff;line-height: 47px;padding-left: 10px;">
            <?php echo lang('common_jobs_name_insert');?></h1>
        </div>
    </div>
    <div id="body">
    ...
    <input type="hidden" value="" id="parent_id_hidden" name="parent_id_hidden" />
      <div style="width: 300px; height: 60px;position: relative;left:300px ">
    <?php
...
//            'id'=>'submit',
    ...
    ?>
    <button type="button" id="button" onclick="previousPage()" style="top:11px; left:0"  class="submit_buttons float_right"><?php echo lang('common_cancer_back')?></button>
      </div>
