...
<div id="title_bar_new">
        <div  id="title" style="color:#fff !important;line-height: 47px;padding-left: 10px;">
    <h1><?php echo lang('common_project_manger_update') ?> </h1>
	 </div>
    </div>
    ...
    <div id="body">
        ...
        <div class="field_row clearfix" id="status_modules" style="width: 100%;border: none;" >
            <div class='form_field'>
                <p style="display: block;margin: 10px 0">N<?php echo lang('common_jobs_my_content');?> :</p>
    ...
    ?>
    <button type="button" id="button" onclick="previousPage()"><?php echo lang('common_cancer_back')?></button>
	</div>
