    ...
    <div class='form_field'>
        ...
        <select name='person_id'  >
            ...
            <?php foreach($name_peron_info AS $key => $values): ?>
                <?php
                	if($values->person_id == $jobs_city->person_id ){?>
...
<div class="field_row clearfix" style="border: none" id="status_module">
    <div class='form_field'>
        <?php echo form_label(lang('common_city_regions_name').':', 'jobs_name',array('class'=>'required')); ?>
        <select name='jobs_regions_id'  required="required">
			<option value="" style="display: none">-- Chọn người khu vực --</option>
