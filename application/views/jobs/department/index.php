...
<div id="content_demo">
    ...
    <script type="text/javascript">
...

        {
            ...
            enable_delete(<?php echo json_encode(lang("confirm_delete_status"));?>,<?php echo json_encode(lang("none_selected_city"));?>);
    ...
    <table id="title_bar_new">
        ...
        <tr>
			...
			<?php
				...
				<a href="<?php echo base_url()?>employees" ><div class="newface_back"></div></a>
			<?php
			}
			?>
            ...
            <td id="title" style="color: #FFF;line-height:40px;padding-left: 5px">

                <?php echo lang($controller_name); ?>
            ...
            <td id="title_search_new">
                ...
                <input type="text" name ='search' id='search' placeholder="Nhập tên phòng ban .."/>
...
<?php //echo anchor("employees",					'Phòng ban - Nhân viên',						array('class'=>'none new', 'title'=>'Phòng ban - Nhân viên'));		?>
