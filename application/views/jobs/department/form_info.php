<div class="field_row clearfix" id="status_module">
    <?php echo form_label(lang('common_department_name').':', 'common_department_name',array('class'=>'required')); ?>
...
<div class="field_row clearfix_affiliates" style="border: none;" id="status_module">
        <div class='form_field'>
            <?php echo form_label(lang('common_affiliates_name').':', 'jobs_name',array('class'=>'required','style'=>'margin-left: 10px;')); ?>
            <select name='jobs_parent_id'  required="" style="margin-left: -10px">
    ...
    <div class='form_field'>
        ...
        <select name='person_id' >
            ...
            <?php foreach($name_peron_info AS $key => $values): ?>
                <?php 
                	if($values->person_id == $jobs_department->person_id ){?>
