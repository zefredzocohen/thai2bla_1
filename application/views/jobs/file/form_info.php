...
<div class="field_row clearfix" id="status_module">
    ...
    <div class='form_field'>
        ...
        echo form_input(array(
                'name'=>'jobs_file_date',
                'id'=>'jobs_file_date',
                'value'=>$jobs_file->jobs_file_date != '1950-01-01'? date(get_date_format(),strtotime($jobs_file->jobs_file_date  != '' ? $jobs_file->jobs_file_date : date('Y-m-d'))) : ''
            )
        )
        ;?>
    </div>
...
<div class="field_row clearfix" id="status_module" style="position: relative;bottom:10px" >
    <?php echo form_label(lang('common_jobs_file').':', 'jobs_reports_content'); ?>
     <?php if($jobs_file->jobs_file_name == null){?>              
                  <div class='form_field'> <span style="font-size:0.81em;font-style:italic;font-weight: normal;line-height: 22px;">Chưa cập nhật file đính kèm!</span> </div>
                <?php } else{?>
                <div class='form_field'><a href="<?php echo base_url() . 'file/file/'.$jobs_file->jobs_file_name ?>"><?php echo $jobs_file->jobs_file_name ?></a></div>
                <?php }?>
    <div class='form_field' >
        <?php echo form_input(array(
            'name'=>'jobs_file_name',
            ...
            'style'=>'border:none;',
            'type'=>'file',
            //'value'=>$jobs_info->jobs_file_name
        ));?>
    </div>
</div>
