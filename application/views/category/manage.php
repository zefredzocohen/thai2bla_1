<?php $this->load->view("partial/header"); ?>
            ...
            $(document).ready(function()
                       {
                    var table_columns = ["", "code_cat", 'name', 'parentid', 'anh', '']; 
            ...
            $('#generate_barcodes').click(function(){
                ...
                if (selected.length == 0){
                    alert(<?php echo json_encode(lang('items _ must_select_i tem_for_barcode')); ?>);
                    return false;
                }
            ...
            $('#generate_barcode_labels').click(function(){
                var selected = get_selected_values();
                if (selected.length == 0){
                    alert(<?php echo json_encode(lang('items_must_select_item_for_ barcod e')); ?>);
                    return false;
                }                
...
<!-- phan lam -->
        ...
        function select_inv(){
                 ...
                 if (confirm(<?php echo json_encode("Bạn có muốn chọn tất cả"); ?>))
...
if ($controller_name == items) {
    ?>
                ...
                <td id="title_search_new">
                    ...
                    <input type="text" name ='search' id='search' placeholder="Tìm loại sản phẩm ... "/>
...
<?php if ($this->Employee->has_module_action_permission($controller_name, 'add_update', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
    ...
    <?php
    echo
    anchor("$controller_name/view/-1/width~$form_width", lang($controller_name . '_new'), array('class' => 'thickbox none new',
    ...
    ?>
                        ...
                        <?php if ($this->Employee->has_module_action_permission($controller_name, 'delete', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
                            <?php echo anchor("$controller_name/delete", lang("common_delete"), array(
                                'id' => 'delete',
