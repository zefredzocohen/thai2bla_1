			...
			<table  id="suspended_sales_table">
				...
				?>
					<tr>
						...
						<td>
							<?php 
							echo form_open('salestraining/receipt/'.$suspended_sale['sale_id'], array('method'=>'get', 'id' => 'form_receipt_suspended_sale'));
							?>
						...
						<td>
							<?php 
							echo form_open('salestraining/delete_suspended_sale', array('id' => 'form_delete_suspended_sale'));
							echo form_hidden('suspended_sale_id', $suspended_sale['sale_id']);
							?>
