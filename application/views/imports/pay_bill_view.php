        ...
        <div style="height:auto">
            <div id="receipt_wrapper" style="width:350px;font-family:times new roman">
                ...
                <?php if (count($receiving_payment_paid_ok) > 0) { ?>
                    ...
                    <a href = "<?= site_url() ?>/suppliers/detail_supplier/<?php echo $supplier->person_id; ?>" id="submit" style="width:100px; color:#FFFFFF;" class="print_report" onclick = "this.style.display = 'none'; window.print()";>In hóa đơn</a>
<?php echo form_close(); ?>	
            </div>
        </div>
    </div>
