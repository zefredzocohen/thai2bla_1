...
<div style="height:auto;">
    <div id="receipt_wrapper" style="width:385px;font-family:times new roman">
        ...
        <div id="receipt_header" >
        	<div id="sale_receipt" style=" font-weight:bold; font-size:24px;width:385px;margin: 0px 0 0 0;text-align: center; text-transform: uppercase"><?php echo 'Hóa đơn nhập khẩu' ?></div>
        ...
        <table style="width:380px;margin:15px 0px;font-size:13pt" class="new-font-size" >
	        ...
	        ?>
                <tr style="font-weight: bold;font-size:11pt;">
                    ...
                    <?php 
                        $currency = $this->Create_invetory->getCurrency();
                                foreach ($currency as $rate) {
                                    if ($this->input->post('currency_id') == $rate->id) {
                                        $item['price'] = ($item['price'] * $rate->currency_rate) / 1000;
                                    }
                                }
                        echo to_currency_unVND_nomar($item['price'] * $item['quantity'] - $item['price'] * $item['quantity'] * $item['discount'] / 100); ?>
                    </td>
