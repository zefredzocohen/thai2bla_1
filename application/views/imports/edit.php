...
<table id="title_bar" style="font-size: 1.75em;height: 50px;margin: auto;width: 950px;background: #37B2C9;
margin-bottom: 5px;">
	<tr>
		<td id="title_icon">
...
<div id="edit_sale_wrapper" style="color:black;">
    <fieldset>
	...
	<?php echo form_label(lang('sales_comment').':', 'comment'); ?>
		<div class='form_field'>
			<?php echo form_textarea(array('name'=>'comment','value'=>$receiving_info['comment'],'rows'=>'4','cols'=>'30', 'id'=>'comment'));?>
		</div>
	</div>
