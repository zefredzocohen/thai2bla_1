...
<?php
echo form_open('bangcap/save/'.$item_info->id_bangcap,array('id'=>'bangcap_form'));
?>
<fieldset id="item_basic_info">
<legend><?php echo lang("items_basic_bangcap"); ?></legend>

<div class="field_row clearfix">
<?php echo form_label(lang('bangcap_name').':', 'name_bangcap',array('class'=>'required wide')); ?>
	<div class='form_field'>
	<?php echo form_input(array(
		'name'=>'name_bangcap',
		'id'=>'name_bangcap',
		'value'=>$item_info->nam_bangcap)
	);?>
	</div>
</div>
...
$(document).ready(function()
{
	...
	$('#bangcap_form').validate({ /*sau khi them submit no se goi lai manage*/
		submitHandler:function(form)
		{
			...
			success:function(response)
			{
				submitting = false;
				tb_remove();
				post_bangcap_form_submit(response);
			},
			dataType:'json'
		});
