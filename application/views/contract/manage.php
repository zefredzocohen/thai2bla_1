  ...
  <tr>
	...
	<?php echo form_open("$controller_name/search",array('id'=>'search_form')); ?>
      <?php /*?><select name="categorysearch" class='select_search' style="width:170px" >
        ...
        <input style="" type="text" name ='search' id='search' placeholder="Nhập mã hợp đồng..."/>
...
<table id="contents">
  <tr>
    <td id="commands"><div id="new_button">
            <?php
                    echo anchor("contractemp_type",'Loại hợp đồng',array('class'=>'none new', 'title'=>'Loại hợp đồng'));
                    ?>
        <?php
