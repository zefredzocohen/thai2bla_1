<?php
echo form_open_multipart('Contracts/save/'.$jobs_employees->jobs_employees_id,array('id'=>'jobs_employees_form'));
?>
<div id="required_fields_message"><?php echo lang('common_fields_required_message'); ?></div>
<div id="error"></div>
<fieldset id="jobs_basic_info" style="width: 100%;height:580px">
    <legend><?php echo lang("contracts_info"); ?></legend>
    <?php $this->load->view("contract/jobs_employees/form_info");
    echo form_submit(array(
            'style'=>'margin-left: 259px;margin-top:30px',
