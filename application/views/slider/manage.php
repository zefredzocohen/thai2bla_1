...
{
    var table_columns = ["","id",'name','img','description',''];
...
<table id="contents">
  <tr>
    <td id="commands"><div id="new_button">
        ...
        <?php echo
                ...
                ?> <?php /*?><?php echo
                    ...
                    lang("categories_cleanup_old_categories"),
                    array('id'=>'cleanup',
                        'class'=>'cleanup'));
                ?><?php */?>
        <?php } ?>
    ...
    <td ><?php if($total_rows > $per_page) { ?>
      ...
      <span style="text-transform:uppercase;padding:10px;display:block;font-weight:700;color:#D95607">Banner Cooker</span>
      <div id="item_table">
        <div id="table_holder"> <?php echo $manage_table_slider_cooker; ?> </div>
      </div>
      </td>
  </tr>
</table>
