    ...
    <div id="content_area">
        <script type="text/javascript">
            $(document).ready(function () {
                var table_columns = ["sale_id", 'sale_time', '', 'customer_id', 'employee_id', '', '', '', '', ''];
                enable_sorting("<?php echo site_url("sales/sale_order_sorting"); ?>", table_columns, <?php echo $per_page; ?>);
                enable_search('<?php echo site_url("sales/sale_order_suggest"); ?>',<?php echo json_encode(lang("common_confirm_search")); ?>);
                enable_select_all();
                enable_checkboxes();
         ...
         <table id="title_bar">
            <tr>
                <td id="title_icon">
                         <a href="<?php echo base_url()?>sales" ><div class="newface_back"></div></a></td>
                <td id="title">Hóa đơn bán hàng</td>
                    ...
                    <div style="float: left; margin-top: 10px;">
                        <table>
                            <tr>
                                ...
                                <td>
                                       <?php echo form_open("sales/sale_order_search", array('id' => 'search_form', 'style' => 'width: 268px; float:right; ')); ?>    
                                    <input type="text" name ='search' id='search' placeholder='Nhập mã hóa đơn bán hàng' style="font-size: 14px; "/>
                ...
                <td id="commands">
                    <div id="new_button">		    
                        <?php //if ($this->Employee->has_module_action_permission($controller_name, 'add_update', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
                            <?php
                            echo
                            anchor("$controller_name/delete_sale", lang("common_delete"), array('id' => 'delete',
