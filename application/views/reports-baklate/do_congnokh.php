...
<p style="font-size:12px; padding-left:100px;"><i>Từ <?php echo $start_date; ?> Đến: <?php echo $end_date; ?></i></p>
</div>
<table id="congnokh">
	<tr>
	...
	<?php $customers_info = $this->Customer->find_customer($code_city['id_city_code']) ; 
