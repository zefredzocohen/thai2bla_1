    ...
    <div id="content_area">
        ...
        <table id="title_bar"  style="height:70px">
            <tr>
                ...
                <td id="title"><?php echo lang('reports_reports'); ?> - <?php echo $title . ' - ' . $company_name; ?></td>
                <td>
                    <a style="font-size:18px;text-decoration: underline; color: #FFF" href="<?php echo base_url() . $link; ?>">Trở lại</a>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td><small style="font-style: italic;font-size: 14px;"><?php echo $subtitle ?></small></td>
                <td></td>
            </tr>
        </table>
        <br />		
        <div style="color:#000">		
            <div style="margin:30px 0 10px 0;;"><h3>Lịch sử mua hàng</h3></div>
            <table id="contents">
                <tr>
                    <td id="item_table">
