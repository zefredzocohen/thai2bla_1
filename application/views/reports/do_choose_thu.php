...
<div>
<a style="font-size:18px;text-decoration: underline; margin-left:850px" href="<?php echo base_url();?>reports/do_choose_date_thu">Trở lại</a>
<h5 style="text-align:left"><?php echo $company; ?></h4>
<h5 style="text-align:left"><?php echo $address; ?></h4>
<?php echo '<h4 style="margin-top:15px; margin-bottom:5px;">Các khoản thu </h4>' ?>
                           ...
                           <tbody style="font-family: arial;font-size: 15px;">
                           		...
                           		<?php foreach ($thu_date as $key): ?>                       		
                           			<tr>
                           				...
                           				<?php if ($key['tien_thu']>0): ?>
                           					<td><?php echo to_currency($key['tien_thu']) ?></td>
                           				<?php else: ?>
                           			...
                           			<?php $stt++; ?>
                               		<?php $subtotal+=$key['tien_thu']?>
                           		<?php endforeach ?>
                               <tr>
                               <td colspan="7" style="font-weight:bold;font-size:18px; text-align: right;">Tổng tiền</td>
                               <td style="font-weight:bold;font-size:13px"><?php echo to_currency($subtotal);?></td>
                               </tr>
                           </tbody>
