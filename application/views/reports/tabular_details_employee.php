        ...
        <table id="title_bar">
            <tr>
                ...
                <td><a
                        ...
                        href="<?php echo base_url(); ?>reports/specific_employee">Trở
                        lại</a></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td style="font-size: 16px; font-style: italic;"><small><?php echo $subtitle ?></small></td>
                <td></td>
            </tr>
        </table>
        <br />
                                                                ...
                                                                foreach ($val3 as $key4 => $val4) {
                                                                    foreach ($val4 as $key5 => $val5) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: center"><?= $this->Unit->get_info($val5['unit_item'] == $val5['unit'] ? $val5['unit'] : $val5['unit_from'])->name ?></td>
