...
<div style="color:#000" id="report_news">
    <table id="title_bar_new" style="color: #FFF;">
        <tr>
            ...
            <td id="title">
                <?php echo 'Hóa đơn nhập khẩu'.' - '.$tille; ?>
...
?>
	...
	<div style="margin-left:10px;" id='report_sale_type'>
        ...
        <?php //echo form_label('Sản phẩm - Dịch vụ', 'reports_sale_type_label', array('class'=>'required','id'=>'label_new','style'=>'margin-left:10px')); ?>
