...
<div id="content_area">
<a style="font-size:18px;text-decoration: underline;color:#000; margin-left:800px" href="<?php echo base_url();?>reports">Trở lại</a>
<div id="page_title" style="margin-bottom:8px;color:#000; font-size: 24px !important;"><?php echo 'Báo cáo chi tiết các đơn hàng'.$title; ?></div>
<?php
if(isset($error))
{
