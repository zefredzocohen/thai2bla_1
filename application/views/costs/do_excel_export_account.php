...
<a style="font-size:18px;text-decoration: underline; margin-left:850px" href=" <?php echo site_url()?>/costs/excel_export_thuchi">Trở lại</a>
<table class="table_cost" border="1px">

<tr>
	<td colspan ="7" style="text-align:center; font-weight:bold;padding: 5px; font-size: 13px;">SỔ QUỸ TIỀN MẶT - TÀI KHOẢN 111</td>
</tr>
<tr>
...
<tr style="text-align:center; font-weight:bold; font-size:13px;">
	...
	<td width="12%">NHÂN VIÊN</td> 
        <td width="6%">TK_NỢ</td> 
        <td width="6%">TK_CÓ</td>     
	<td width="9%">TIỀN THU</td> 
	<td width="9%">TIỀN CHI</td>
        <td width="10%">TỒN</td> 
...
<tr style="font-size:12px;font-family:Arial, Helvetica, sans-serif">
	...
	<td style="text-align: right;"><?php
        $money_thu = $cost['form_cost']==0 ? $cost['money'] : 0; 
        echo number_format($money_thu);
//		if($cost['form_cost']==0) echo number_format($cost['money']); 
//		else echo 0 ; ?>
	</td>     
	<td style="text-align: right;"><?php 
        $money_chi = $cost['form_cost']==1 ? $cost['money'] : 0; 
        echo number_format($money_chi);
//		if($cost['form_cost']==1) echo number_format($cost['money']); 
//		else echo 0 ; 
	?></td>
        <td style="text-align: right;"><?php echo number_format($money_thu - $money_chi); ?></td>  
</tr>
<?php    
    }}
	else { ?>
...
<tr style="font-weight:bold; height:30px;">	
        ...
        <td style="text-align:right;"><?php echo number_format($cost_tien_thu - $cost_tien_chi); ?></td>
