...
<div id="content_area_wrapper">
    <div id="content_area" style="color:#000;line-height: 35px;height: 200px">
        <a style="font-size:18px;text-decoration: underline; margin-left:850px;" href=" <?= site_url()?>accountings/ban_hang">Trở lại</a>
        <h3 style="margin-left: 50px;padding-bottom: 10px; margin-top: -30px">Chọn ngày xuất</h3>
        <?php echo form_open("costs/do_report_cong_no_khach_hang", array('id' => 'excel_export')); ?>   
        ...
        <div style="margin-left: 50px;" class='form_field'>
            <select name="customer_id" id="customer_id">            
                ...
                <?php $tam = $this->Customer->get_all_customer();
                foreach ($tam as $tam1) {
                    ?>            
                    <option value= '<?php echo $tam1['person_id'] ?>'><?= $tam1['first_name'] . ' ' . $tam1['last_name'] ?></option>
                <?php }
                ?>
            </select> (*)
        </div>
