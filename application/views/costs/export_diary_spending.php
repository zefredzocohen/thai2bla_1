...
<br>
<div style="font-size: 15px; text-align:center; font-weight:bold;padding: 5px;">SỔ NHẬT KÝ CHI TIỀN</div>
...
<tr style="text-align:center; font-weight:bold;background-color: #999999">
	<td rowspan ="3" width="8%">NGÀY THÁNG GHI SỔ</td>
        ...
        <td rowspan="3" width="9%">GHI CÓ TÀI KHOẢN 111, 112</td>
        <td colspan="6">GHI NỢ CÁC TÀI KHOẢN</td>
</tr>
<br>
<tr style="text-align:center; font-weight:bold; background-color: #999999">
        <td rowspan="2" width="5%">SỐ HIỆU</td>
	<td rowspan="2" width="8%">NGÀY THÁNG</td>
        <td rowspan="2" width="8%">331</td>
	<td rowspan="2" width="8%">334</td>
        <td rowspan="2" width="8%">641</td>
        <td rowspan="2" width="8%">642</td>
...
<tr style="font-size: 12px;">
    ...
    <td style="text-align: right;"><?php if($data_diary['tk_no']=='331'){echo number_format($data_diary['money']);}?></td>
    <td style="text-align: right;"><?php if($data_diary['tk_no']=='334'){echo number_format($data_diary['money']);}?></td>
    <td style="text-align: right;"><?php if($data_diary['tk_no']=='641'){echo number_format($data_diary['money']);}?></td>
    <td style="text-align: right;"><?php if($data_diary['tk_no']=='642'){echo number_format($data_diary['money']);}?></td>    
    <?php if($data_diary['tk_no']!= '331' && $data_diary['tk_no']!= '334' && $data_diary['tk_no']!='641' && $data_diary['tk_no']!='642'){?>
        <td style="text-align: right;"> <?php echo number_format($data_diary['money']);?></td>
        <td style="text-align: center;"><?php echo $data_diary['tk_no']?></td>
    <?php }else{?>
        <td></td>
        <td></td>
    <?php }?>
