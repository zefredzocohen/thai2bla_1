    ...
    <div id="content_area">
        <script type="text/javascript">
            ...
            function getb(coun, term, per_page)
            {
                ...
                var head = ["", 'id', "name", 'first_name', 'description', 'value', ''];
        ...
        <table id="title_bar_new">
            <tr>
                ...
                <td id="title_search_new" style="width:519px;">
                    ...
                    <input type="text" name ='search' id='search' placeholder="Tên hoặc mã hợp đồng ... " />
        ...
        <table id="contents">
            <tr>
                <td id="commands"><div id="new_button">
                        <?php
                        echo anchor("contractcustomer_type", 'Loại hợp đồng', array('class' => 'none new', 'title' => 'Loại hợp đồng'));
                        ?>
                        ...
                        <?php if ($this->Employee->has_module_action_permission($controller_name, 'delete', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>
                            <?php
                            echo
                            anchor("$controller_name/delete", lang("common_delete"), array('id' => 'delete',
