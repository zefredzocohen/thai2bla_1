    ...
    <div id="content_area">
        ...
        <table id="title_bar_new">
            <tr>
                <td id="title_icon">
                    <?php
                    if ($controller_name == contractcustomer) {
                        ?>
                        <img src='<?php echo base_url() ?>images/menubar/<?php echo $controller_name; ?>.png' alt='title icon' />
                        <?php } else {
                        ?>
                        <a href="<?php echo base_url()?>contracts" ><div class="newface_back"></div></a>
                        <?php
                    }
                    ?>
                </td>
                ...
                <td id="title_search_new">
                    ...
                    <input type="text" name ='search' id='search' placeholder="Tên loại hợp đông khách hàng ... "/>
        ...
        <table id="contents">
            <tr>
                <td id="commands">
                    ...
                    <?php
                    //echo anchor("contractcustomer",'Hợp đồng với khách hàng',array('class'=>'none new', 'title'=>'Hợp đồng với khách hàng'));
                    ?>

                    <div id="new_button">		
                        <?php if ($this->Employee->has_module_action_permission($controller_name, 'add_update', $this->Employee->get_logged_in_employee_info()->person_id)) { ?>					
                            <?php
                            echo anchor("$controller_name/view/-1/width~$form_width/height~440", lang($controller_name . '_new'), array('class' => 'thickbox none new', 'title' => lang($controller_name . '_new')));
                            ?>
                        <?php } ?>
