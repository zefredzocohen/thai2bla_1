...
class Summary_items extends Report
{
	...
	public function getDataColumns()
	{
		return array(
					...
					array('data'=>lang('reports_quantity'), 'align'=> 'center'),
	...
	{
		$this->db->select('name, items.quantity , sum(quantity_purchased) as quantity_purchased, 
			sum(subtotal) as subtotal, sum(total) as total, sum(taxes*subtotal/100) tax, sum(profit) as profit, items.taxes');
	...
	{
		$this->db->select('sum(subtotal) as subtotal, sum(taxes*subtotal/100) as tax, 
