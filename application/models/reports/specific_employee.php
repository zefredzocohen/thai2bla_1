...
class Specific_employee extends Report
{
	...
	public function getDataColumns()
	{
		return array('summary' => array(
						...
						array('data'=>'Chiết khấu(%)', 'align'=>'left'), 
	...
	{
		$this->db->select('sale_id, sale_time, sale_date,discount_percent, sum(quantity_purchased) as items_purchased, CONCAT_WS(" ",first_name,last_name) as customer_name, sum(subtotal) as subtotal, sum(total) as total, sum(tax) as tax, sum(profit) as profit, payment_type, comment', false);
