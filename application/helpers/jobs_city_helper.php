...
function get_city_data_row($data,$controller)
{
	...
	$table_data_row.='<td width="15%" style="color:#000;height:45px;color:'.$data->jobs_city_color.'""><p style="display:inline-block;margin:0px 0 0 2px;min-height:20px;height:auto;float:left;width:130px;padding:8px 0 5px 0;color:'.$data->jobs_city_color.'">'
    	.anchor("employees/switch_jobs_city/$data->jobs_city_id", $data->jobs_city_name,array( 'title'=>lang($controller_name.'_update'))).'
    	</a>
    </p></td>';    
