...
$this->excel->getActiveSheet()->setCellValue('D8'," 0105945538");
...
$this->excel->getActiveSheet()->setCellValue('F12'," TMCP Đầu tư và Phát triển Việt Nam  - Chi nhánh BIDV Hà Nội");
...
$this->excel->getActiveSheet()->setCellValue('G22'," Tổng Số lượng");
$this->excel->getActiveSheet()->setCellValue('H22',"Đơn giá");
$this->excel->getActiveSheet()->setCellValue('I22',"Thành tiền");

$this->excel->getActiveSheet()->setCellValue('J22',"Kích thước");
$this->excel->getActiveSheet()->setCellValue('K22',"SL");
...
$this->excel->getActiveSheet()->setCellValue('G23',"(Total Quantity)");
...
$this->excel->getActiveSheet()->getStyle('J23')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
$this->excel->getActiveSheet()->setCellValue('J23',"(Dài,Rộng)");
$this->excel->getActiveSheet()->getStyle('J23')->getFont()->setItalic(true);

$this->excel->getActiveSheet()->getStyle('K23')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
$this->excel->getActiveSheet()->setCellValue('K23',"(Quantity)");
$this->excel->getActiveSheet()->getStyle('K23')->getFont()->setItalic(true);

$this->excel->getActiveSheet()->getStyle('A23:K23')->getFont()->setSize(9);

$this->excel->getActiveSheet()->getStyle('A23:K23')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_TOP);
//DEN DAY
$this->excel->getActiveSheet()->getStyle('F22:K22')->getFont()->setBold(true);
$this->excel->getActiveSheet()->getStyle('F22:K22')->getFont()->setSize(9);
$this->excel->getActiveSheet()->getStyle('F22:K22')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
$this->excel->getActiveSheet()->getStyle('B24:K24')->getFont()->setBold(true);
$this->excel->getActiveSheet()->getStyle('B24:K24')->getFont()->setSize(8);
$this->excel->getActiveSheet()->getStyle('F24:K24')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
/* */
...
foreach(array_reverse($data['cart'], true) as $line=>$item){
	...
	$this->excel->getActiveSheet()->setCellValue('I'.$k,to_currency_unVND_nomar($item['price']*$item['quantity']-$item['price']*$item['quantity']*$item['discount']/100));
         ...
         $this->excel->getActiveSheet()->setCellValue('J'.$k,$item['m2_length'].', '.$item['m2_width']);
        $this->excel->getActiveSheet()->getStyle('J'.$k)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
        
        $this->excel->getActiveSheet()->setCellValue('K'.$k,$item['m2_quantity']);
        $this->excel->getActiveSheet()->getStyle('K'.$k)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
        
$this->excel->getActiveSheet()->getStyle('B'.$k.':K'.$k)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
        $this->excel->getActiveSheet()->getStyle('B'.$k.':K' . ($k))->applyFromArray($styleDOTBlackBorderOutline);
...
$this->excel->getActiveSheet()->getStyle('J25:J'.($k-1))->getBorders()->getRIGHT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('K25:K'.($k-1))->getBorders()->getRIGHT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
/* end style border cot */
if($k < 41){
for($a = $k ;$a < 41;$a++){
		$this->excel->setActiveSheetIndex(0)->mergeCells('C'.$a.':E'.$a);
	    $this->excel->getActiveSheet()->getStyle('B'.$a.':K' . ($a))->applyFromArray($styleDOTBlackBorderOutline);
...
$this->excel->getActiveSheet()->getStyle('J'.($k).':I40')->getBorders()->getRIGHT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('K'.($k).':I40')->getBorders()->getRIGHT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
/* end style border cot */
...
$this->excel->getActiveSheet()->getStyle('B'.($i+3).':K'.($i+2))->getBorders()->getBOTTOM()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('B'.($i).':K'.($i))->getBorders()->getTOP()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
$this->excel->getActiveSheet()->setCellValue('K'.$i,to_currency_unVND_nomar($tongtienhang));
...
$this->excel->getActiveSheet()->getStyle('B'.($i+1).':K'.($i+1))->getBorders()->getTOP()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
$this->excel->getActiveSheet()->setCellValue('K'.($i+1),to_currency_unVND_nomar($data['total'] - $tongtienhang));
$this->excel->getActiveSheet()->getStyle('K'.($i+1))->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
$this->excel->getActiveSheet()->getStyle('K'.($i+1))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
$this->excel->getActiveSheet()->getStyle('K'.($i+1))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
$this->excel->getActiveSheet()->getStyle('K'.($i+1))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
$this->excel->getActiveSheet()->getStyle('K'.($i+1))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
...
$this->excel->getActiveSheet()->getStyle('B'.($i+2).':K'.($i+2))->getBorders()->getTOP()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
foreach($data['payments'] as $payment_id=>$payment)
 {
    $this->excel->getActiveSheet()->setCellValue('K'.($i+2),to_currency_unVND_nomar($payment['payment_amount']));
    $this->excel->getActiveSheet()->getStyle('K'.($i+2))->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
 }
...
$this->excel->getActiveSheet()->getStyle('K'.($i+2))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
...
$this->excel->getActiveSheet()->getStyle('B'.($i+3).':K'.($i+3))->getBorders()->getTOP()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
$this->excel->getActiveSheet()->getStyle('K'.($i+3))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
$this->excel->getActiveSheet()->getStyle('K'.($i+3))->getFont()->setSize(11);
if($payments_cost > 0){
    $this->excel->getActiveSheet()->setCellValue('K'.($i+3),to_currency_unVND_nomar($payments_cost));
    $this->excel->getActiveSheet()->getStyle('K'.($i+3))->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
}elseif($payments_cost == 0){
    $this->excel->getActiveSheet()->setCellValue('K'.($i+3),'0 VNĐ');
    $this->excel->getActiveSheet()->getStyle('K'.($i+3))->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
}
...
$this->excel->getActiveSheet()->getStyle('B'.($i+4).':K'.($i+4))->getBorders()->getTOP()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
$this->excel->getActiveSheet()->getStyle('B1:K1')->getBorders()->getTOP()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('J1:K24')->getBorders()->getRIGHT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
$this->excel->getActiveSheet()->getStyle('B7:K7')->getBorders()->getTOP()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('B14:K14')->getBorders()->getTOP()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
//$this->excel->getActiveSheet()->getStyle('B22:J22')->getBorders()->getBOTTOM()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('B22:K22')->getBorders()->getTOP()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('B23:K23')->getBorders()->getBOTTOM()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('B24:K24')->getBorders()->getBOTTOM()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
$this->excel->getActiveSheet()->getStyle('I23:K24')->getBorders()->getLEFT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('J23:K24')->getBorders()->getLEFT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('K23:K24')->getBorders()->getLEFT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
$this->excel->getActiveSheet()->getStyle('I22:K23')->getBorders()->getLEFT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('J22:K23')->getBorders()->getLEFT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
$this->excel->getActiveSheet()->getStyle('K22:K23')->getBorders()->getLEFT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);

$this->excel->getActiveSheet()->getStyle('K'.($i).':K'.($i+3))->getBorders()->getRIGHT()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
...
$this->excel->getActiveSheet()->getColumnDimension('G')->setWidth(12.9);
...
$this->excel->getActiveSheet()->getColumnDimension('J')->setWidth(10.08);
$this->excel->getActiveSheet()->getColumnDimension('K')->setWidth(10.08);
