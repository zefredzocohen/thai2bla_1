...
$this->excel->getActiveSheet()->setCellValue('D1', "DANH SÁCH GÓI HÀNG");

$this->excel->getActiveSheet()->setCellValue('A2', "Mã mặt hàng");
$this->excel->getActiveSheet()->setCellValue('B2', "tên gói hàng");
$this->excel->getActiveSheet()->setCellValue('C2', "loại");
$this->excel->getActiveSheet()->setCellValue('D2', "Giá nhập");
$this->excel->getActiveSheet()->setCellValue('E2', "giá bán");
$this->excel->getActiveSheet()->setCellValue('F2', "Thuế GTGT");
$this->excel->getActiveSheet()->setCellValue('G2', "Thuế xuất 1");
$this->excel->getActiveSheet()->setCellValue('H2', "Thuế mua hàng");
$this->excel->getActiveSheet()->setCellValue('I2', "Thế xuất 2");
$this->excel->getActiveSheet()->setCellValue('J2', "Tích lũy");
$this->excel->getActiveSheet()->setCellValue('K2', "Mô tả");
$k =3;
...
$filename = 'thongtin_goihang.xlsx'; //save our workbook as this file name
//$filename = 'Book1.xlsx';
