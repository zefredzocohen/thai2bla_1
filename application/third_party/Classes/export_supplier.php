...
$this->excel->getActiveSheet()->setCellValue('D1', "DANH SÁCH NHÀ CUNG CẤP");

$this->excel->getActiveSheet()->setCellValue('A2', "Tên công ty");
$this->excel->getActiveSheet()->setCellValue('B2', "Tên riêng");
$this->excel->getActiveSheet()->setCellValue('C2', "Tên họ");
$this->excel->getActiveSheet()->setCellValue('D2', "E-mail");
$this->excel->getActiveSheet()->setCellValue('E2', "Số điện thoại");
$this->excel->getActiveSheet()->setCellValue('F2', "Địa chỉ 1");
$this->excel->getActiveSheet()->setCellValue('G2', "Địa chỉ 2");
$this->excel->getActiveSheet()->setCellValue('H2', "Thành phố");
$this->excel->getActiveSheet()->setCellValue('I2', "Tỉnh");
$this->excel->getActiveSheet()->setCellValue('J2', "Mã vùng");
$this->excel->getActiveSheet()->setCellValue('K2', "Quốc gia");
$this->excel->getActiveSheet()->setCellValue('L2', "Ghi chú");
$this->excel->getActiveSheet()->setCellValue('M2', "Mã nhà cung cấp");
$k =3;
foreach ($rows as $key=>$r) {
	...
	//$name_supplier);die;
	  ...
	  $this->excel->getActiveSheet()->setCellValue('L' . $k, $r[11]);
	  $this->excel->getActiveSheet()->setCellValue('M' . $k, $r[12]);
...
$this->excel->getActiveSheet()->getStyle('A2:M' . ($count+5))->applyFromArray($styleThinBlackBorderOutline);
...
$filename = 'thongtin_nhacungcap.xlsx'; //save our workbook as this file name
//$filename = 'Book1.xlsx';
