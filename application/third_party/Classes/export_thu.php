...
//name the worksheet
$this->excel->getActiveSheet()->setTitle('Báo cáo tiền thu 1 khách hàng');
...
$this->excel->getActiveSheet()->setCellValue('F1',"Mẫu số 01 - TT");
...
$this->excel->getActiveSheet()->getStyle('H4:I4')->getFont()->setSize(12);
	...
	$this->excel->getActiveSheet()->setCellValue('A6', "PHIẾU THU");
...
$this->excel->getActiveSheet()->setCellValue('G8', "Nợ: 1111");
$this->excel->getActiveSheet()->setCellValue('G9', "Có: 1331");
...
$this->excel->getActiveSheet()->setCellValue('C10', $this->Person->get_info($cost->id_customer)->first_name.' '.$this->Person->get_info($cost->id_customer)->last_name);
...
$this->excel->getActiveSheet()->setCellValue('B13', to_currency_unVND_nomar($cost->tien_thu));
...
$this->excel->getActiveSheet()->setCellValue('A14', "Bằng chữ: ");
$this->excel->getActiveSheet()->setCellValue('A14', "(Bằng chữ: ".$this->Cost->get_string_number($cost->tien_thu)."./.)");
...
$filename = 'thongtin_thutien_kh.xlsx'; //save our workbook as this file name
//$filename = 'Book1.xlsx';
