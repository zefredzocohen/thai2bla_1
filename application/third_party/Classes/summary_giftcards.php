...
//name the worksheet
$this->excel->getActiveSheet()->setTitle('Báo cáo tổng hợp thẻ quà tặng');
...
$this->excel->getActiveSheet()->getStyle('A2')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
    ...
    $this->excel->getActiveSheet()->setCellValue('A4', "BÁO CÁO TỔNG HỢP THẺ QUÀ TẶNG");
...
$this->excel->getActiveSheet()->setCellValue('A6', "Mã số thẻ quà tặng");
$this->excel->getActiveSheet()->setCellValue('B6', "Giá trị");
$this->excel->getActiveSheet()->setCellValue('C6', "Tên khách hàng");
$this->excel->getActiveSheet()->getStyle('A6:C6')->getFont()->setSize(12)->setBold(true);
...
$k =7;
 foreach ($report_data as $key => $r) {
	 ...
	 $this->excel->getActiveSheet()->setCellValue('C' . $k, $r['customer_name']);
	  $k++;
 }
