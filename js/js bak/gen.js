...
//-- Vui l�ng ko s?a ch� th�ch khi d�ng l?i code

//===========More Button cong no ==============//
jQuery(document).ready(function(){
	jQuery('a.hunght_warning_debt').click(function(){
		jQuery('.drop_warning_debt').css('left',Math.floor(jQuery('a.hunght_warning_debt').position().left+jQuery('a.hunght_warning_debt').width()-jQuery('.drop_warning_debt').width()));
		jQuery('.drop_warning_debt').slideToggle(100);
	});

	jQuery('.drop_warning_debt').hover(function(){
		//No thing
	},
	function(){
		jQuery('.drop_warning_debt').slideUp(100);
	});
});

//===========More Button new customers ==============//
jQuery(document).ready(function(){
	jQuery('a.hunght_warning_customer').click(function(){
		jQuery('.drop_warning_customer').css('left',Math.floor(jQuery('a.hunght_warning_customer').position().left+jQuery('a.hunght_warning_customer').width()-jQuery('.drop_warning_customer').width()));
		jQuery('.drop_warning_customer').slideToggle(100);
	});

	jQuery('.drop_warning_customer').hover(function(){
		//No thing
	},
	function(){
		jQuery('.drop_warning_customer').slideUp(100);
	});
});


//===========More Button new orders ==============//
jQuery(document).ready(function(){
	jQuery('a.hunght_warning_orders').click(function(){
		jQuery('.drop_warning_orders').css('left',Math.floor(jQuery('a.hunght_warning_orders').position().left+jQuery('a.hunght_warning_orders').width()-jQuery('.drop_warning_orders').width()));
		jQuery('.drop_warning_orders').slideToggle(100);
	});

	jQuery('.drop_warning_orders').hover(function(){
		//No thing
	},
	function(){
		jQuery('.drop_warning_orders').slideUp(100);
	});
});

//===========More Button new contract ==============//
jQuery(document).ready(function(){
	jQuery('a.hunght_warning').click(function(){
		jQuery('.drop_warning_contract').css('left',Math.floor(jQuery('a.hunght_warning').position().left+jQuery('a.hunght_warning').width()-jQuery('.drop_warning_contract').width()));
		jQuery('.drop_warning_contract').slideToggle(100);
	});

	jQuery('.drop_warning_contract').hover(function(){
		//No thing
	},
	function(){
		jQuery('.drop_warning_contract').slideUp(100);
	});
});

//===========More Button new Web orders ==============//
jQuery(document).ready(function(){
	jQuery('a.hunght_web').click(function(){
		jQuery('.drop_warning_web').css('left',Math.floor(jQuery('a.hunght_web').position().left+jQuery('a.hunght_web').width()-jQuery('.drop_warning_web').width()));
		jQuery('.drop_warning_web').slideToggle(100);
	});

	jQuery('.drop_warning_web').hover(function(){
		//No thing
	},
	function(){
		jQuery('.drop_warning_web').slideUp(100);
	});
});

//===========More Button new new jobs==============//
jQuery(document).ready(function(){
	jQuery('a.hunght_warning_contract').click(function(){
		jQuery('.drop_warning_jobs').css('left',Math.floor(jQuery('a.hunght_warning_contract').position().left+jQuery('a.hunght_warning_contract').width()-jQuery('.drop_warning_jobs').width()));
		jQuery('.drop_warning_jobs').slideToggle(100);
	});

	jQuery('.drop_warning_jobs').hover(function(){
		//No thing
	},
	function(){
		jQuery('.drop_warning_jobs').slideUp(100);
	});
});

//===========More Button new new profit==============//
jQuery(document).ready(function(){
	jQuery('a.hunght_warning_profit').click(function(){
		jQuery('.drop_warning_profit').css('left',Math.floor(jQuery('a.hunght_warning_profit').position().left+jQuery('a.hunght_warning_profit').width()-jQuery('.drop_warning_profit').width()));
		jQuery('.drop_warning_profit').slideToggle(100);
	});

	jQuery('.drop_warning_profit').hover(function(){
		//No thing
	},
	function(){
		jQuery('.drop_warning_profit').slideUp(100);
	});
});

//===========More Button new new warehouse==============//
jQuery(document).ready(function(){
	jQuery('a.hunght_warning_warehouse').click(function(){
		jQuery('.drop_warning_warehouse').css('left',Math.floor(jQuery('a.hunght_warning_warehouse').position().left+jQuery('a.hunght_warning_warehouse').width()-jQuery('.drop_warning_warehouse').width()));
		jQuery('.drop_warning_warehouse').slideToggle(100);
	});

	jQuery('.drop_warning_warehouse').hover(function(){
		//No thing
	},
	function(){
		jQuery('.drop_warning_warehouse').slideUp(100);
	});
});
	...
	if(THIS_SCRIPT!=undefined && THIS_SCRIPT=='newthread')
	{
		...
		jQuery('.vbform').submit(function(){
			if(jQuery.trim(jQuery('#tagpopup_ctrl').val())=='')
			{
				...
				//--Chu?n h�a title
				var reg=/[^a-zA-Z\s????????????????????��?�?�a��?�?�A??????????��???���???���?i?��?I?????????�???????????��?�?�o��?�?�O??????????��?u?u��?U?U�????�????d�]/i;
				while(reg.test(sj)){
					sj=sj.replace(reg,' ');
				}
				while(sj.indexOf('  ')!=-1){
