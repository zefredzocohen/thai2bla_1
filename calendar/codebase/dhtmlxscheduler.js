...
scheduler.init = function(a, b, c) {
    ...
    (function() {
        function a() {
            return{w: window.innerWidth || document.documentElement.clientWidth, h: window.innerHeight ||
...
scheduler.locale = {date: {month_full: "Tháng 1,Tháng 2,Tháng 3,Tháng 4,Tháng 5,Tháng 6,Tháng 7,Tháng 8,Tháng 9,Tháng 10,Tháng 11,Tháng 12".split(","), month_short: "Tháng 1,Tháng 2,Tháng 3,Tháng 4,Tháng 5,Tháng 6,Tháng 7,Tháng 8,Tháng 9,Tháng 10,Tháng 11,Tháng 12".split(","), day_full: "Chủ nhật,Thứ 2,Thứ 3,Thứ 4,Thứ 5,Thứ 6,Thứ 7".split(","), day_short: "Chủ nhật,Thứ 2,Thứ 3,Thứ 4,Thứ 5,Thứ 6,Thứ 7".split(",")}, labels: {dhx_cal_today_button: "Hôm nay", day_tab: "Ngày",back_page: "Quay lại", week_tab: "Tuần", month_tab: "Tháng", new_event: "Sự kiện mới", icon_save: "Lưu", icon_cancel: "Hủy", icon_details: "Chi tiết",
        icon_edit: "Sửa", icon_delete: "Xóa", confirm_closing: "", confirm_deleting: "Sự kiện sẽ bị xóa vĩnh viễn, bạn chắc chắn muốn xóa?", section_description: "Mô tả", section_time: "Thời hạn", full_day: "Cả ngày", confirm_recurring: "Bạn có muốn chỉnh sửa toàn bộ các sự kiện lặp đi lặp lại?", section_recurring: "Sự kiện lặp lại", button_recurring: "Disabled", button_recurring_open: "Kích hoạt", button_edit_series: "Edit series", button_edit_occurrence: "Edit occurrence", agenda_tab: "Agenda", date: "Thời gian", description: "Tên công việc",
        year_tab: "Năm", week_agenda_tab: "Agenda", grid_tab: "Grid", drag_to_create: "Drag to create", drag_to_move: "Kéo để di chuyển"}};
